...
export const ACHIEVEMENTS: Record<string, AchievementDef> = {
	...
	FIRST_PVP_SCROLL: {
		id: "FIRST_PVP_SCROLL",
		title: "Red Writ",
		description: "Claim your first PvP bounty scroll.",
		icon: "R",
		category: "combat",
		sortOrder: 4,
	},
	MET_DAWN_GUILD_LEADER: {
		id: "MET_DAWN_GUILD_LEADER",
		title: "Dawn Audience",
		description: "Bring a PvP bounty scroll to Bertram.",
		icon: "D",
		category: "social",
		sortOrder: 5,
	},
	FIRST_PVP_TURN_IN: {
		id: "FIRST_PVP_TURN_IN",
		title: "Justice Paid",
		description: "Turn in your first PvP bounty scroll.",
		icon: "J",
		category: "general",
		sortOrder: 6,
	},

...
export const WEAPONS: Record<string, WeaponDef> = {
	...
	noble_sword: {
		id: "noble_sword",
		name: "Noble Sword",
		description: "A polished noble sidearm, worn as much for status as defense.",
		effect: "+10 melee damage. Reliable and quick.",
		weaponType: "Blade",
		icon: "/",
		rarity: "epic",
		deliveryType: "dagger",
		heldModelName: "Noble Sword",
		handedness: "oneHanded",
	},
	royal_longsword: {
		id: "royal_longsword",
		name: "Royal Longsword",
		description: "A ceremonial great blade carried by the realm's highest bloodlines.",
		effect: "+12 melee damage. Heavy two-handed blade.",
		weaponType: "Blade",
		icon: "/",
		rarity: "legendary",
		deliveryType: "dagger",
		heldModelName: "Royal Longsword",
		handedness: "twoHanded",
	},
	royal_wand: {
		id: "royal_wand",
		name: "Royal Wand",
		description: "A jeweled wand carried as a symbol of royal authority.",
		effect: "+10 melee damage. Ceremonial royal focus.",
		weaponType: "Staff",
		icon: "T",
		rarity: "legendary",
		deliveryType: "dagger",
		heldModelName: "Royal Wand",
		handedness: "oneHanded",
	},
	royal_mace: {
		id: "royal_mace",
		name: "Royal Mace",
		description: "A gilded mace for rulers who prefer judgment with weight.",
		effect: "+11 melee damage. Heavy royal sidearm.",
		weaponType: "Blunt",
		icon: "T",
		rarity: "legendary",
		deliveryType: "dagger",
		heldModelName: "Royal Mace",
		handedness: "oneHanded",
	},
	royal_greataxe: {
		id: "royal_greataxe",
		name: "Royal Greataxe",
		description: "A two-handed executioner's axe dressed in royal finery.",
		effect: "+13 melee damage. Heavy two-handed axe.",
		weaponType: "Axe",
		icon: "T",
		rarity: "legendary",
		deliveryType: "dagger",
		heldModelName: "Royal Greataxe",
		handedness: "twoHanded",
	},
	royal_axe: {
		id: "royal_axe",
		name: "Royal Axe",
		description: "A compact royal axe with an edge kept bright for ceremony and threat.",
		effect: "+11 melee damage. Reliable royal sidearm.",
		weaponType: "Axe",
		icon: "T",
		rarity: "legendary",
		deliveryType: "dagger",
		heldModelName: "Royal Axe",
		handedness: "oneHanded",
	},
	halberd: {
		id: "halberd",
